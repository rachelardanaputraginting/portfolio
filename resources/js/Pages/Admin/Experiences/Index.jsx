...
export default function Index(props) {
    ...
    const { data: experiences, meta, links } = props.experiences;
    ...
    return (
        <>
            ...
            <Container>
                <Title title="Admin - Experience" active={true} />
            </Container>

            <Container>
                <Link href={route('admin.experiences.create')} className='rounded px-2 py-1.5 text-sm bg-gradient-to-r from-sky-600 to-fifth mb-4 flex items-center gap-1 my-12 max-w-max text-third'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                                ...
                                <>
                                    <tr key={experience.id}>
                                        ...
                                        <Table.Td className='flex gap-2'>
                                            ...
                                            <Link href={route('admin.experiences.edit', experience.slug)} className='transition duration-300 ease-linear px-1.5 py-1.5 rounded hover:scale-125 bg-gradient-to-r from-yellow-500 to-fifth'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
