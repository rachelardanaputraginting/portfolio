...
export default function Index({ work_experiences }) {
    ...
    const handleSearch = (e) => {
        ...
        get(`/experiences/work_experiences?query=${e.target.value}`);
    };
        ...
        <>
            ...
            <Container>
                <div className="scrolling-wrapper flex flex-nowrap overflow-x-scroll gap-4">
                    ...
                    <Navigation href={route('experiences.workall')} className={clsx(usePage().url == usePage().url && 'from-red-500')}>Work Experiences</Navigation>
