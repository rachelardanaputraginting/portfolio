            ...
            <Container>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <CardHorizontal icon={<svg xmlns=" http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-react" width={120} height={120} viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <CardHorizontal.Badge badge="Web Developer" className={'from-green-500 px-2.5 py-1 bg-gradient-to-r text-base'} />
                        <CardHorizontal.Title title="Sari Roti Aceh Utara" />
                        ...
                        <CardHorizontal.Footer year="2021 - NOW" location="Lhokseumawe" position="Employee" />
                    </CardHorizontal >
                    <CardHorizontal icon={<svg xmlns=" http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-react" width={120} height={120} viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path d="M6.306 8.711c-2.602 .723 -4.306 1.926 -4.306 3.289c0 2.21 4.477 4 10 4c.773 0 1.526 -.035 2.248 -.102" />
                        ...
                        <CardHorizontal.Badge badge="Operator" className={'from-green-500 px-2.5 py-1 bg-gradient-to-r text-base'} />
                        <CardHorizontal.Title title="Kejaksaan Negeri Langsa" />
                        <CardHorizontal.Description description="Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste quas, obcaecati accusantium dolorem quod delectus tempora veniam deserunt laudantium vitae quos aspernatur nemo tenetur!" />
                        <CardHorizontal.Footer year="2019 - 2019" location="Langsa" position="Intership" />
                    </CardHorizontal >
                </div>
            </Container >
        </>
