...
export default function Index({ count_soft_skill, ...props }) {
    const { data: soft_skills, meta, links } = props.soft_skills;
    ...
    const handleSearch = (e) => {
        ...
        get(`/skills/soft_skills?query=${e.target.value}`);
    };
        ...
        <>
            ...
            <Container>
                <div className="scrolling-wrapper flex flex-nowrap overflow-x-scroll gap-4">
                    ...
                    <Navigation href={route('skills.softall')} className={clsx(usePage().url == usePage().url && 'from-red-500')}>Soft Skills</Navigation>
            ...
            <Container>
                <Title title="Soft Skills" subtitle="Here are some of my abilities in the field of Web Developer" />
            </Container>
