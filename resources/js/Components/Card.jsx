        ...
        <div>
            <div className="h-64 from-fifth rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative overflow-hidden">
                <Link href="#" className='bg-black w-full '>
                    <img className="rounded-lg h-full w-full" src="https://flowbite.com/docs/images/blog/image-1.jpg" alt="" />
                </Link>
                <div className="p-5 absolute top-0 hover:top-0 pt-64 hover:pt-28 transition-all duration-300 right-0 left-0 -bottom-40 hover:bg-gradient-to-t from fourth via-fourth to-transparent">
                    {children}
                </div>
            </div>
        </div >
...
function Subtitle({ subtitle }) {
    return (
        <p className="mb-3 text-third font-light text-sm dark:text-gray-400">{subtitle}.</p>
    )
}
